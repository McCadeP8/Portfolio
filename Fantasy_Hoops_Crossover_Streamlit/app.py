...
with col1:
    ...
    with col6:
        ...
        st.metric(label = "Strength of Schedule", value = get_team_stat(RPI, SelectedTeam1, "SOS"), delta = get_team_stat(base_records, SelectedTeam1, "SOS_Rk"), delta_color = "off", border = True)
