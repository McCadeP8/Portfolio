...
with col1:
    ...
    with col5:
        ...
        st.metric(label = "Points Per Week", value = get_team_stat(PPG, SelectedTeam1, "Avg_Score"), delta = get_team_stat(base_records, SelectedTeam1, "PPG_Rk"), delta_color = "off", border = True)
