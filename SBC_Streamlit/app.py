...
with tab6:
    ...
    with col1:
        SelectedTeam1 = st.selectbox("Select Your Team1:", Teams, index=Teams.index("Vegas"))
        SelectedTeam2 = st.selectbox("Select Your Team2:", Teams, index=Teams.index("Vegas"))
    with col2:
        SelectedTeam3 = st.selectbox("Select Your Team3:", Teams, index=Teams.index("Vegas"))
        SelectedTeam4 = st.selectbox("Select Your Team4:", Teams, index=Teams.index("Vegas"))
