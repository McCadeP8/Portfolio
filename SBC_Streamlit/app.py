...
from data import team_info, type_colors, current_salary_cap, current_luxury_tax, current_apron_1, current_apron_2, current_year, columns_order, year_offset, max_cash, league_ids, team_id_history, period
...
with tab3:
    ...
    if update:
        ...
        team_week_stats = team_with_ranks(live_stats_df, SelectedTeam)
