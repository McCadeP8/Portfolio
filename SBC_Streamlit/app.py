...
with tab4:
    ...
    with col1:
        render_scorebug(live_stats_total_scores.iloc[0], index=0)
        render_scorebug(live_stats_total_scores.iloc[1], index=1)
        render_scorebug(live_stats_total_scores.iloc[2], index=2)
        render_scorebug(live_stats_total_scores.iloc[3], index=3)
        render_scorebug(live_stats_total_scores.iloc[4], index=4)
    with col2:
        render_scorebug(live_stats_total_scores.iloc[5], index=5)
        render_scorebug(live_stats_total_scores.iloc[6], index=6)
        render_scorebug(live_stats_total_scores.iloc[7], index=7)
        render_scorebug(live_stats_total_scores.iloc[8], index=8)
        render_scorebug(live_stats_total_scores.iloc[9], index=9)
    with col3:
        render_scorebug(live_stats_total_scores.iloc[10], index=10)
        render_scorebug(live_stats_total_scores.iloc[11], index=11)
        render_scorebug(live_stats_total_scores.iloc[12], index=12)
        render_scorebug(live_stats_total_scores.iloc[13], index=13)
        render_scorebug(live_stats_total_scores.iloc[14], index=14)
    with col4:
        render_scorebug(live_stats_total_scores.iloc[15], index=15)
        render_scorebug(live_stats_total_scores.iloc[16], index=16)
        render_scorebug(live_stats_total_scores.iloc[17], index=17)
        render_scorebug(live_stats_total_scores.iloc[18], index=18)
        render_scorebug(live_stats_total_scores.iloc[19], index=19)
    with col5:
        render_scorebug(live_stats_total_scores.iloc[20], index=20)
        render_scorebug(live_stats_total_scores.iloc[21], index=21)
        render_scorebug(live_stats_total_scores.iloc[22], index=22)
        render_scorebug(live_stats_total_scores.iloc[23], index=23)
        render_scorebug(live_stats_total_scores.iloc[24], index=24)
    with col6:
        render_scorebug(live_stats_total_scores.iloc[25], index=25)
        render_scorebug(live_stats_total_scores.iloc[26], index=26)
        render_scorebug(live_stats_total_scores.iloc[27], index=27)
        render_scorebug(live_stats_total_scores.iloc[28], index=28)
        render_scorebug(live_stats_total_scores.iloc[29], index=29)
...
with tab10:
    ...
    with col1:
        ...
        ASBC1 = get_single_award(award_history, ft_players, all_time_rosters, pics, 2025, "All-SBC 1st Team")
    ...
    with col2:
        ...
        ASBC2 = get_single_award(award_history, ft_players, all_time_rosters, pics, 2025, "All-SBC 2nd Team")
    ...
    with col1:
        ...
        WCPOM = get_short_term_awards(award_history, ft_players, all_time_rosters, pics, 2025, "Player of Month", "West")
        ...
        WCROM = get_short_term_awards(award_history, ft_players, all_time_rosters, pics, 2025, "Rookie of Month", "West")
        ...
        WCPOW = get_short_term_awards(award_history, ft_players, all_time_rosters, pics, 2025, "Player of Week", "West")
    ...
    with col2:
        ...
        ECPOM = get_short_term_awards(award_history, ft_players, all_time_rosters, pics, 2025, "Player of Month", "East")
        ...
        ECROM = get_short_term_awards(award_history, ft_players, all_time_rosters, pics, 2025, "Rookie of Month", "East")
        ...
        ECPOW = get_short_term_awards(award_history, ft_players, all_time_rosters, pics, 2025, "Player of Week", "East")
