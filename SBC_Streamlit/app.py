...
with tab3:
    ...
    with col2:
        ...
        team_week_stats = team_with_ranks(get_matchup_stats(SelectedYear, SelectedPeriod), SelectedTeam)
        ...
        season_line_chart_data = team_stats_line_chart(all_time_team_stats, SelectedTeam, SelectedCategory)
