...
with tab1:
    ...
    with col1:
        ...
        st.metric(label = "Net Fee", value = net_fee(df, SelectedTeam, base_cap), delta = amount_paid(df, SelectedTeam), delta_color = "normal", help = "The first number shows current total owed for the season, including base payment, In-Season Tournament fee, tax penalties, winnings, and tax payouts. The second number shows how much has been paid so far.", border = True, format = "dollar")
