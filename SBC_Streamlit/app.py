...
with tab11:
    ...
    with col1:
        ...
        ASW = get_all_stars_award(award_history, ft_players, all_time_rosters, pics, AwardYears, "All-Star", "West")
        ...
        WCPOM = get_short_term_awards(award_history, ft_players, all_time_rosters, pics, AwardYears, "Player of Month", "West")
        ...
        WCROM = get_short_term_awards(award_history, ft_players, all_time_rosters, pics, AwardYears, "Rookie of Month", "West")
        ...
        WCPOW = get_short_term_awards(award_history, ft_players, all_time_rosters, pics, AwardYears, "Player of Week", "West")
    ...
    with col2:
        ...
        ASE = get_all_stars_award(award_history, ft_players, all_time_rosters, pics, AwardYears, "All-Star", "East")
        ...
        ECPOM = get_short_term_awards(award_history, ft_players, all_time_rosters, pics, AwardYears, "Player of Month", "East")
        ...
        ECROM = get_short_term_awards(award_history, ft_players, all_time_rosters, pics, AwardYears, "Rookie of Month", "East")
        ...
        ECPOW = get_short_term_awards(award_history, ft_players, all_time_rosters, pics, AwardYears, "Player of Week", "East")
        ...
        ASGMVP = get_single_award(award_history, ft_players, all_time_rosters, AwardYears, 2025, "ASG MVP")
