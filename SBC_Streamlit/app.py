...
from trade_machine import tradeable_players_in, tradeable_players_out
...
with tab6:
    ...
    with st.form("team_selection_form"):
        with col1:
            ...
            SelectedTeam2 = st.multiselect("Incoming Players:", tradeable_players_in(df, SelectedTeam))
        with col2:
