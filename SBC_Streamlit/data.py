...
team_info = {
    ...
    "San Jose": {"bg": "#97EBF4", "bg2": "#0BB5FF", "text": "black", "logo": "https://pbs.twimg.com/media/Fxam0EvaIAAcI_3?format=png&name=small", "nickname": "Seagulls"},
    "Seattle": {"bg": "#006241", "bg2": "#EDFF21", "text": "white", "logo": "https://pbs.twimg.com/media/Fxam1s5aAAIanao?format=png&name=small", "nickname": "Brew"},
    "St. Louis": {"bg": "#B7B1AE", "bg2": "#FFFFFF", "text": "black", "logo": "https://pbs.twimg.com/media/Fxam1ugaEAUkbUi?format=png&name=small", "nickname": "66ers"},
    "Tampa Bay": {"bg": "#FC8EAC", "bg2": "#B90E0A", "text": "black", "logo": "https://pbs.twimg.com/media/G_eTqPpacAIV82Y?format=png&name=small", "nickname": "Flamingos"},
    "Tulsa": {"bg": "#333333", "bg2": "#313639", "text": "white", "logo": "https://pbs.twimg.com/media/Fxam1s7aQAAiSsW?format=png&name=small", "nickname": "Tornado"},
    "Vancouver": {"bg": "#17780D", "bg2": "#656565", "text": "black", "logo": "https://pbs.twimg.com/media/Fxam4eaaMAAW6Pz?format=png&name=small", "nickname": "Forest"},
    "Vegas": {"bg": "#35654D", "bg2": "#CACE00", "text": "white", "logo": "https://pbs.twimg.com/media/Fxam4dlaIAIKnBb?format=png&name=small", "nickname": "Blackjack"},
}
