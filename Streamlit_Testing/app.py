...
with col2:
    ...
    st.dataframe(styled_active, width = "stretch", height = "content", row_height = 100, hide_index=True, placeholder="—", column_order=("Picture_Online", "Player", "Y2026", "Y2027", "Y2028", "Y2029", "Y2030","Y2031", "Y2032"), column_config={"Picture_Online": st.column_config.ImageColumn("Picture_Online", width="small")})
    if not inactive_df.empty:
        ...
        st.dataframe(styled_inactive, width = "stretch", height = "content", hide_index=True, placeholder="—", column_order=("Picture_Online", "Player", "Y2026", "Y2027", "Y2028", "Y2029", "Y2030", "Y2031", "Y2032"), column_config={"Picture_Online": st.column_config.ImageColumn("Picture_Online", width="small")})